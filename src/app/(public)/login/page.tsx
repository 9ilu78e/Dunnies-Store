    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-50 to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-purple-100 p-8 backdrop-blur-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm pt-1">
              ...
              <Link href="/forgot-password" className="text-purple-600 hover:text-purple-800 font-semibold">
                Forgot password?
              </Link>
            </div>
        ...
        <p className="text-center text-sm text-gray-600 mt-8">
          ...
          <Link href="/signup" className="text-purple-600 hover:text-purple-800 hover:underline font-bold">
            Create one now
          </Link>
        </p>
      </div>
